                ...
                <form action="{{ route('formbuilder::forms.store') }}" method="POST" id="createFormForm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="type" class="col-form-label">Service Type</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="price" type="text" class="form-control" name="price" value="price" required autofocus placeholder="Enter service price">
